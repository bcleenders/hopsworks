...
cd /root/ca
openssl genrsa -aes256 -out private/ca.key.pem -passout pass:adminpw 4096
...
cd /root/ca
openssl genrsa -aes256 -out intermediate/private/intermediate.key.pem -passout pass:adminpw 4096
